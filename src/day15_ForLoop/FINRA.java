...
public class FINRA {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 1; i <= 100; i++){
            if(i % 15 == 0) {// numbers which are a multiple of both 3 and 5 also divisible by 15
                System.out.print("FINRA");
            }else if(i % 3 == 0) {//numbers which are a multiple of 3
                System.out.print("FIN");
            }else if( i % 5 == 0) {// numbers which are a multiple of 5
                System.out.print("RA");
            }else{ // other numbers not divisibke by 3 or 5
                System.out.print(i+ " ");
